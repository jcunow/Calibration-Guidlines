...
- Does tube insertion angle and tube diameter affect rotational prevalence bias?
- Does tube inseetion angle and tube diameter change root growth angles i.e., barrier escape trajectories?  
...
<img src= 'https://github.com/user-attachments/assets/dd22baf2-630b-440a-832e-d09eb0f4cb57' width="100%" height="100%">
  ...
  * You need a ruler/tape measure and an angle measurements device (all modern phones can measure angles (typically 1-2° deviation)). 
  ...
  2) Note down the outer tube diameter. A diameter of 5.7 cm (2.25 in)  and 7 cm (2.75 in) is very common - usually the same for all tubes.
  3) Note down where soil starts in the image.
